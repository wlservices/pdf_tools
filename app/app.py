...
app.config['MAIL_PASSWORD'] = 'U!(UqhJ09'
...
@app.route('/merge-pdf-page', methods=["GET", "POST"])
def merge_pdf_page():
...
@app.route('/compress-pdf-page', methods=["GET", "POST"])
...
@app.route('/word-to-pdf-page', methods=["GET", "POST"])
...
@app.route('/image-to-pdf-page', methods=["GET", "POST"])
...
@app.route('/pdf-to-word-page', methods=["GET", "POST"])
...
@app.route('/pdf-to-excel-page', methods=["GET", "POST"])
